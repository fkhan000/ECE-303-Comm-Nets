...
class EntityA:
    ...
    def output(self, message):
        ...
        print("SENDING PACKET " + str(self.seqnum) + " " + str(round(get_time(self))) + "\n")
        packet = Pkt(self.seqnum, self.ACK, hash(message.data), message.data)
    ...
    def timer_interrupt(self):
        ...
        print("------------SENDER----------")
        print("ACK " + str(self.ACK) + " FOR PACKET " + str(self.seqnum) + " WASN'T RECEIVED, TIMER WENT OFF" + " " + str(round(get_time(self))))
        to_layer3(self, self.prevPack)

        print("RESENDING PACKET " + str(self.seqnum) +"\n")
        start_timer(self, 100.0)
